  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{asset('site_admin')}}/img/brand/logo.svg" width="89" height="25" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{asset('site_admin')}}/img/brand/sygnet.svg" width="30" height="30" alt="CoreUI Logo">
      </a>
