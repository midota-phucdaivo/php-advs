<ul class="nav">
    ...
    @foreach ( slidebar() as $menu )
        ...
        <a class="{{ isset($menu['childrens']) ? 'nav-link nav-dropdown-toggle' : 'nav-link' }}" @if( isset($menu['link'])) href="{{ route($menu['link']) }}" @endif>
            <i class="nav-icon {{ isset($menu['icon']) ? $menu['icon'] : 'icon-pencil' }}"></i>{{ $menu['name'] }}
        </a>
        ...
        <ul class="nav-dropdown-items">
            ...
            <li class="nav-item">
                <a class="nav-link"
                    @if( isset($menuChild['link']))
                        href="{{ route($menuChild['link']) }}"
                    @endif
                    @if( isset($menuChild['url']))
                        href="{{ url()->action($menuChild['url']) }}"
                    @endif>
                    <i class="nav-icon
